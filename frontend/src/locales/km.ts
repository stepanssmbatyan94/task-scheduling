export default {
  ...
  tasks: {
    ...
    dueDate: {
      tooltip: {
        overdue:
          'កិច្ចការបានផុតកំណត់ {count} ថ្ងៃមកហើយ | កិច្ចការបានផុតកំណត់ {count} ថ្ងៃមកហើយ',
        today: 'កិច្ចការត្រូវដល់កំណត់ថ្ងៃនេះ',
        upcoming: 'ដល់កំណត់ក្នុងរយៈពេល {count} ថ្ងៃ | ដល់កំណត់ក្នុងរយៈពេល {count} ថ្ងៃ'
      }
    }
  }
};
