import type { Permission, PermissionId } from './resource-type';

export function getResourcePermissionIds(
...
export function getPermissionIdsFromValuesToPermissionIds(
  permissionFormValues: Record<string, PermissionId[]> | undefined
): PermissionId[] {
